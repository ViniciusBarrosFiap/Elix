...
- Nível 4 (dissertativa, técnica de Feynman — a etapa que marca o conceito como DOMINADO): a pergunta deve pedir EXPLICITAMENTE que o estudante explique o conceito  em linguagem simples, sem jargão técnico, usando analogias do dia a dia quando fizer sentido. Essa é a técnica de Feynman: só se domina de verdade um conceito que se consegue explicar de forma simples pra quem não entende do assunto. Redija a própria pergunta nesses termos (ex: "Explique com suas palavras, como se estivesse ensinando alguém que nunca ouviu falar sobre [conceito], o que é/como funciona..."). Não tem alternativas nem "resposta" — em vez disso, gere "resposta_modelo": um parágrafo curto, também em linguagem simples e com analogia quando couber, que sirva de gabarito pro aluno comparar com a própria explicação e se autoavaliar.
